...
import { offcharts, ensurePanes, makePane, destroyPane, buildPaneOverlays, sizeLayers, place, resetPanes, panes as panesApi, removePane as removePaneApi, movePane, addPane as addPaneApi } from './core/panes.js';
...
class Chart {
  ...
  _rebuild() {
    ...
    const { layout, sub, interval } = buildLayout({
      ...
      colors, font: fontFor(this._options), timezone: this._comp.$props.timezone, yTransforms, layersMeta, offcharts: offchartDescriptors(this), logScale: this._modeOf(0) === 1, scaleMode: this._modeOf(0), scaleMargins: /** @type {any} */ (this._mainMargins), ib: this._ib, mainGridHeight: this._stretch[0],
