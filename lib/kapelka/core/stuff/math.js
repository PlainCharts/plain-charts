...
/** @typedef {[number, number]} Pt  a 2-D point [x, y] (the author's points are [x,y] arrays) */
/** @typedef {[number, number]} Rng a price range [hi, lo] */

export default {

    // Distance from point to line
    // p1 = point, (p2, p3) = line
    /** @param {Pt} p1 @param {Pt} p2 @param {Pt} p3 @returns {number} */
    point2line(p1, p2, p3) {
    ...
    /** @param {Pt} p1 @param {Pt} p2 @param {Pt} p3 @returns {{ area: number, base: number }} */
    tri(p1, p2, p3) {
    ...
    */
    ...
    // Triangle height
    /** @param {number} area @param {number} base @returns {number} */
    tri_h(area, base) {
	    return area / base
    },
    ...
    /** @param {Rng} r @param {number} h @returns {number} */
    log_mid(r, h) {
    ...
    /** @param {Rng} r1 @param {number} hi2 @param {number} mid @returns {number} */
    re_range(r1, hi2, mid) {
