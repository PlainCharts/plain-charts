...
/**
 * @param {{ count?: number, startTime?: number, step?: number, startPrice?: number, seed?: number }} [opts]
 * @returns {import('../core/types.js').Bar[]}
 */
...
/**
 * @param {import('../studies/types.js').StudyBar[]} bars
 * @param {number} [period]
 * @returns {import('../studies/types.js').StudyPlotPoint[]}
 */
