...
export async function loadProtocol() {
  ...
  root.resolvePath = (/** @type {string} */ origin, /** @type {string} */ target) =>
    target.startsWith(base) ? target : base + target;
...
export const BAR_STATUS = {
  ...
  106: 'INVALID_PARAMS',
  107: 'ACTIVE_REQUESTS_LIMIT',
  108: 'SUBSCRIPTION_LIMIT',
  109: 'REQUEST_RATE_LIMIT',
  110: 'NOT_SUPPORTED',
