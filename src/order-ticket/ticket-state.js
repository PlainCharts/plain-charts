...
export const state = {
  ...
  // Quantity-type: how the Volume field is READ -- 'units' (contracts) | 'stake' ($ risk). The dropdown lives
  // in the Volume row, so it shows on every entry tab and the choice carries across Market/Limit/Stop.
  qtType: 'units',
